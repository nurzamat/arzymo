 ...
 */
public class PelicanAdapter extends RecyclerView.Adapter<PelicanAdapter.ViewHolder> {
    ...
    PelicanAdapter(String Titles[],int Icons[],String Name,String Email, int Profile,Context passedContext){ // PelicanAdapter Constructor with titles and icons parameter
        // titles, icons, name, email, profile pic are passed from the main _MainActivity as we
    ...
    @Override
    public PelicanAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(PelicanAdapter.ViewHolder holder, int position) {
